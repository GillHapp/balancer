...
import {IPoolLiquidity} from "../lib/balancer-v3-monorepo/pkg/interfaces/contracts/vault/IPoolLiquidity.sol";
import {FixedPoint} from "../lib/balancer-v3-monorepo/pkg/solidity-utils/contracts/math/FixedPoint.sol";
import {Math} from "../lib/balancer-v3-monorepo/pkg/vault/contracts/BasePoolMath.sol";

contract ConstantProductPool is IBasePool, IPoolLiquidity, BalancerPoolToken {
    ...
    function computeBalance(
        ...
        newBalance =
            ...
            balancesLiveScaled18[otherTokenIndex];
    }
